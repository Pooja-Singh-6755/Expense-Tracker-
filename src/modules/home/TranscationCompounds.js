...
const  TranscationCompounds = (props) => {
  const [filterdTransaction , updateTxn]=useState(props.transactions);
  ...
  return (
    ...
    {filterdTransaction?.length?filterdTransaction.map((payload)=>(<TransactionCell payload={payload}/>)):""}
     </Container>
  )
}

export default  TranscationCompounds;